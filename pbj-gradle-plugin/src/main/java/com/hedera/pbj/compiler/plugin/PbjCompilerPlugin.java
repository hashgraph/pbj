...
package com.hedera.pbj.compiler.plugin;
...
public abstract class PbjCompilerPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        com.hedera.pbj.compiler.PbjSourceDirectorySet pbjSourceSet =
                createPbjSourceDirectorySet(
                        ((DefaultSourceSet) mainSrcSet).getDisplayName(), getObjectFactory());
        mainSrcSet
                .getExtensions()
                .add(com.hedera.pbj.compiler.PbjSourceDirectorySet.class, com.hedera.pbj.compiler.PbjSourceDirectorySet.NAME, pbjSourceSet);
        ...
        TaskProvider<com.hedera.pbj.plugin.compiler.PbjCompilerTask> pbjCompiler =
                project.getTasks()
                        .register(
                                taskName,
                                com.hedera.pbj.plugin.compiler.PbjCompilerTask.class,
                                pbjTask -> {
     ...
     */
    private static com.hedera.pbj.compiler.PbjSourceDirectorySet createPbjSourceDirectorySet(
        ...
        com.hedera.pbj.compiler.PbjSourceDirectorySet pbjSourceSet =
                objectFactory.newInstance(
                        com.hedera.pbj.plugin.compiler.DefaultPbjSourceDirectorySet.class,
