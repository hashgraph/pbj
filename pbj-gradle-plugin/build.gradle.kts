...
mainModuleInfo {
    ...
    requires("com.hedera.pbj.compiler")
}
...
gradlePlugin {
    plugins {
        ...
        create("compiler") {
            ...
            implementationClass = "com.hedera.pbj.compiler.plugin.PbjCompilerPlugin"
            displayName = "PBJ Compiler"
            description = "The PBJ Gradle plugin provides protobuf compilation to java records."
