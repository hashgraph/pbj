...
public class OneOfTestData {
    ...
    private static final Everything.Builder BASE = Everything.newBuilder()
        .int32Number(1234)
        .text("base message")
        .booleanField(true);
    ...
    public static final Everything WITH_INT32_ONEOF =
        BASE.int32NumberOneOf(42).build();
    ...
    public static final Everything WITH_UNSET_ONEOF =
        BASE.build();
