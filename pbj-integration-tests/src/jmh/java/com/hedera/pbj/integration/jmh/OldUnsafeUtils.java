...
/// A copy of UnsafeUtils prior to PBJ 0.15.0.
/// It's okay to keep this class in pbj-integration-tests for now.
/// But we'll have to delete it together with the benchmark once we upgrade to a JDK version
/// that no longer offers the sun.misc.Unsafe APIs.
class OldUnsafeUtils {
