...
public final class ExtendedUtf8MessageWithStringTest {
    ...
    public void testMessageWithStringAgainstProtoC(final NoToStringWrapper<MessageWithString> modelObjWrapper)
            throws Exception {
    ...
    static {
        ...
        ARGUMENTS = IntStream.range(0, maxValues)
                .mapToObj(i -> new MessageWithString(aTestStringList.get(Math.min(i, aTestStringList.size() - 1))))
                .toList();
    }
}
