...
public final class TimestampTestTest {
    ...
    public void testTimestampTestAgainstProtoC(final NoToStringWrapper<TimestampTest> modelObjWrapper)
            throws Exception {
    ...
    static {
        ...
        final int maxValues =
                IntStream.of(secondsList.size(), nanosList.size()).max().getAsInt();
