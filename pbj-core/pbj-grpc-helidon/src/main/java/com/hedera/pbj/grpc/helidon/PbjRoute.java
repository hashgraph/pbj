...
abstract class PbjRoute implements Route {
     ...
     * @return The {@link PbjMethodRoute} object that represents the gRPC service and method that should be invoked, or null.
     */
    abstract /*@Nullable*/ PbjMethodRoute toPbjMethodRoute(final @NonNull HttpPrologue grpcPrologue);
     ...
     */
    abstract @NonNull PathMatchers.MatchResult accepts(final @NonNull HttpPrologue prologue);
}
