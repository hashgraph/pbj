...
class NonCryptographicHashTest {
    //      * TEST: what happens if position > length of the byte array?
    //     * TEST: what happens if position < 0?
    //     * TEST: what happens if length < 0?
    //     * TEST: what happens if position + length > byte array length?
    //     * TEST: what happens if the byte array is 0? (with length = 0 and position = 0. Anything else is illegal with byte array 0).
    ...
    void testHash64ByteArrayEmpty() {
        assertEquals(3230899725752021667L, NonCryptographicHashing.hash64(new byte[0]));
    }
    ...
    void testHash64ByteArrayEmptyWithPositionAndLength() {
        assertEquals(3230899725752021667L, NonCryptographicHashing.hash64(new byte[0], 0, 0));
    }
    ...
    void testHash64ByteArrayLessThan8Bytes() {
        byte[] arr = {(byte) 1};
        assertEquals(1450858126797791778L, NonCryptographicHashing.hash64(arr));
    }
    ...
    void testHash64ByteArray8Bytes() {
        ...
        assertEquals(-5416501487484278819L, NonCryptographicHashing.hash64(arr));
    }
    ...
    void testHash64ByteArrayMoreThan8ButNotMultipleOf8Bytes() {
        ...
        assertEquals(8717726722998256023L, NonCryptographicHashing.hash64(arr));
    }
    ...
    void testHash64ByteArrayMultipleOf8Bytes() {
        ...
        assertEquals(-5797446293423483272L, NonCryptographicHashing.hash64(arr));
    }
