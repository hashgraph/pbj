...
public class OmnibusSchema {
    public static final FieldDefinition INT32_NUMBER = new FieldDefinition("int32Number", FieldType.INT32, false, 10);
    public static final FieldDefinition INT64_NUMBER = new FieldDefinition("int64Number", FieldType.INT64, false, 11);
    public static final FieldDefinition UINT32_NUMBER = new FieldDefinition("uint32Number", FieldType.UINT32, false, 12);
    public static final FieldDefinition UINT64_NUMBER = new FieldDefinition("unit64Number", FieldType.UINT64, false, 13);
    ...
    public static final FieldDefinition SINT32_NUMBER = new FieldDefinition("sint32Number", FieldType.SINT32, false, 30);
    public static final FieldDefinition SINT64_NUMBER = new FieldDefinition("sint64Number", FieldType.SINT64, false, 31);
    public static final FieldDefinition SFIXED32_NUMBER = new FieldDefinition("sfixed32Number", FieldType.SFIXED32, false, 20);
    public static final FieldDefinition SFIXED64_NUMBER = new FieldDefinition("sfixed64Number", FieldType.SFIXED64, false, 25);
    public static final FieldDefinition FIXED32_NUMBER = new FieldDefinition("fixed32Number", FieldType.FIXED32, false, 21);
    public static final FieldDefinition FIXED64_NUMBER = new FieldDefinition("fixed64Number", FieldType.FIXED64, false, 26);
    ...
    public static final FieldDefinition INT32_UNIQUE = new FieldDefinition("int32Unique", FieldType.INT32, false, 210);
    public static final FieldDefinition INT64_UNIQUE = new FieldDefinition("int64Unique", FieldType.INT64, false, 211);
    public static final FieldDefinition UINT32_UNIQUE = new FieldDefinition("uint32Unique", FieldType.UINT32, false, 212);
    public static final FieldDefinition UINT64_UNIQUE = new FieldDefinition("uint64Unique", FieldType.UINT64, false, 213);
    ...
    public static final FieldDefinition SINT32_UNIQUE = new FieldDefinition("sint32Unique", FieldType.SINT32, false, 230);
    public static final FieldDefinition SINT64_UNIQUE = new FieldDefinition("sint64Unique", FieldType.SINT64, false, 231);
    public static final FieldDefinition SFIXED32_UNIQUE = new FieldDefinition("sfixed32Unique", FieldType.SFIXED32, false, 220);
    public static final FieldDefinition SFIXED64_UNIQUE = new FieldDefinition("sfixed64Unique", FieldType.SFIXED64, false, 225);
    public static final FieldDefinition FIXED32_UNIQUE = new FieldDefinition("fixed32Unique", FieldType.FIXED32, false, 221);
    public static final FieldDefinition FIXED64_UNIQUE = new FieldDefinition("fixed64Unique", FieldType.FIXED64, false, 226);
    ...
    public static final FieldDefinition INT32_REPEATED = new FieldDefinition("int32NumberList", FieldType.INT32, true, 300);
    public static final FieldDefinition INT64_REPEATED = new FieldDefinition("int64NumberList", FieldType.INT64, true, 301);
    public static final FieldDefinition UINT32_REPEATED = new FieldDefinition("uint32NumberList", FieldType.UINT32, true, 302);
    public static final FieldDefinition UINT64_REPEATED = new FieldDefinition("uint64NumberList", FieldType.UINT64, true, 303);
    ...
    public static final FieldDefinition SINT32_REPEATED = new FieldDefinition("sint32NumberList", FieldType.SINT32, true, 306);
    public static final FieldDefinition SINT64_REPEATED = new FieldDefinition("sint64NumberList", FieldType.SINT64, true, 307);
    public static final FieldDefinition SFIXED32_REPEATED = new FieldDefinition("sfixed32NumberList", FieldType.SFIXED32, true, 308);
    public static final FieldDefinition SFIXED64_REPEATED = new FieldDefinition("sfixed64NumberList", FieldType.SFIXED64, true, 309);
    public static final FieldDefinition FIXED32_REPEATED = new FieldDefinition("fixed32NumberList", FieldType.FIXED32, true, 310);
    public static final FieldDefinition FIXED64_REPEATED = new FieldDefinition("fixed64NumberList", FieldType.FIXED64, true, 311);
