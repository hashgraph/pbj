...
/**
 * Represents buffered {@link SequentialData}. The buffer may be on-heap or off-heap, backed by a byte array or
...
public interface BufferedSequentialData extends SequentialData, RandomAccessData {
    /**
     * Sets the {@link #position()} to the given value and leave the {@link #limit()} alone. The position must be
