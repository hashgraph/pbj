...
class CodecParseMethodGenerator {
    ...
    static String generateParseMethod(
        ...
        return """
                 ...
                 * @param maxDepth sets the {@link PbjReader#MaxDepthReached} error if the depth of nested messages exceeds it.
                 ...
                 * @throws ParseException if parsing a nested message field fails
                 */
    ...
    static ParseAndDefaultBody generateParseLoop(
        ...
        list.add("""
                        ...
                        if (wireType > 5) {
                            input.setError(PbjReader.IOError, "Cannot understand wire_type of " + wireType);
                            return $unknownFields;
                        }
                        ...
                        if ($prefixf == null) {
                            if (strictMode) {
                                ...
                                input.setError(PbjReader.UnknownField, String.valueOf($prefixfield));
                                return $unknownFields;
