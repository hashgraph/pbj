...
class CodecParseMethodGenerator {
    ...
    static String generateParseMethod(
        ...
        return """
                ...
                private List<UnknownField> defaultCase(int tag, int field, FieldDefinition f, boolean strictMode, boolean parseUnknownFields, List<UnknownField> $unknownFields, SlimBuffer input, int maxSize) throws IOException {
                    $defaultCaseBody
